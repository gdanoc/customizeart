<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="32_Update_image.aspx.cs" Inherits="CustomizeArt._32_Update_image" %>
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
    ...
    <title>Tables | Admin - Update Image</title>
...
<asp:Button ID="btonlogout" runat="server" CssClass="btn btn-primary" Text="Log Out" OnClick="btonlogout_Click" />                            </h1>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3 myform-cont">
                                                ...
                                                <div class="myform-bottom">
                                                    ...
                                                    <div class="form-group center-container">
                                                        <asp:TextBox ID="Texto" runat="server" placeholder="Text..." type="text" class="form-control" onpaste="return false" onkeypress="return validar(event)" minlength="3"></asp:TextBox>
                                                    </div>
                                                    <div class="form-group center-container">
                                                        <asp:Label ID="LabelFoto" runat="server" CssClass="form-label" Text="Image"></asp:Label>
                                                        <asp:FileUpload ID="PhotoFile" CssClass="form-control" name="File" runat="server" />
                                                    </div>
                                                    <div class="form-group center-container">
                                                        <asp:Button ID="btnSeleccionar" runat="server" Text="Select" margin-top="50px" Style="width: 150px; padding: 10px; margin: 0 auto; display: block;" CssClass="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white" OnClick="btnSeleccionar_Click"></asp:Button>
                                                        <asp:Button ID="btnEditar" runat="server" Text="Update" margin-top="50px" Style="width: 150px; padding: 10px; margin: 0 auto; display: block;" CssClass="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white" OnClick="btnEditar_Click"></asp:Button>
                                                        <asp:Button ID="btnEliminar" runat="server" margin-top="50px" Style="width: 150px; padding: 10px; margin: 0 auto; display: block;" CssClass="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white" Text="Delete" OnClick="btnEliminar_Click" />
                                                    </div>
