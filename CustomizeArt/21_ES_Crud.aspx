<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="21_ES_Crud.aspx.cs" Inherits="CustomizeArt._21_ES_Crud" %>
                ...
                <header class="bg-nav">
                    <div class="flex justify-between">
                        <div class="p-1 mx-3 inline-flex items-center">
                            ...
                            <asp:Button ID="btonlogout" runat="server" CssClass="btn btn-primary" Text="Cerrar Sesión" OnClick="btonlogout_Click" />
                        ...
                        <div class="header-dropdown">
                            ...
                            <div class="header-menu">
                                <ul>
                                    <li><a href="21_Crud.aspx">Inglés</a></li>
                                </ul>
                            </div>
                            <!-- End .header-menu -->
                        </div>
                            ...
                            <ul class="list-reset flex flex-col">
                                ...
                                <ul class="list-reset flex flex-col">
                                    ...
                                    <ul class="list-reset flex flex-col">
                                        ...
                                        <ul class="w-full h-full py-3 px-2 border-b border-light-border">
                                            <li class="w-full h-full py-3 px-2 border-b border-light-border">
                                                <a href="40_ES_Create_Seller.aspx"
                                                    class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                                                    <i class="fab fa-wpforms float-left mx-2"></i>
                                                    Crear Vendedores
                            ...
                            <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                                <div class="shadow-lg bg-red-vibrant border-l-8 hover:bg-red-vibrant-dark border-red-vibrant-dark mb-2 p-2 md:w-1/4 mx-2">
                                    <div class="p-4 flex flex-col">
                                        ...
                                        <a href="#" class="no-underline text-white text-lg">Ventas Totales
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="shadow bg-warning border-l-8 hover:bg-warning-dark border-warning-dark mb-2 p-2 md:w-1/4 mx-2">
                                    <div class="p-4 flex flex-col">
                                        ...
                                        <a href="#" class="no-underline text-white text-lg">Usuarios Totales
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="shadow bg-success border-l-8 hover:bg-success-dark border-success-dark mb-2 p-2 md:w-1/4 mx-2">
                                    <div class="p-4 flex flex-col">
                                        ...
                                        <a href="#" class="no-underline text-white text-lg">Productos Totales
                                        </a>
                                    </div>
                                </div>
                            </div>
