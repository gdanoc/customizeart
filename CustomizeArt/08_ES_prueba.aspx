<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="08_ES_prueba.aspx.cs" Inherits="CustomizeArt._08_ES_prueba" %>
            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" href="01_ES_Login.aspx">Inicio de Sesión</li>
                    </ol>
                </div>
                <!-- End .container -->
            </nav>
...
<div class="col-md-6">
            ...
            <div class="demo-inline-spacing">
                <asp:RadioButtonList ID="colorRadioButtonList" runat="server" >
                    ...
                    <asp:ListItem Text="Negro" Value="Negro" />
                </asp:RadioButtonList>
            </div>
        </div>
        <asp:Button runat="server" Text="AAgregar al carrito" CssClass="btn btn-primary" OnClick="Unnamed1_Click" />
...
<script>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-about">
                        ...
                        <p>Customize Art es un sitio en donde puedes personalizar productos con tu propio estilo.</p>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget">
                        <h4 class="widget-title">Links Útiles</h4>
                        <!-- End .widget-title -->
                        ...
                        <ul class="widget-list">
                            ...
                            <li><a >O a través de nuestro contacto profesional: customizeart2024@gmail.com</a></li>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget">
                        <h4 class="widget-title">Servicio de Personalización</h4>
                        <!-- End .widget-title -->
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="footer-copyright">Copyright © 2024 Customize Art Store. Todos los servicios de personalizacion reservados.</p>
