...
{
    public partial class _24_ES_Update : System.Web.UI.Page
    {
        ...
        protected void Unnamed2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txtid.Text.Trim() != "" && txtid.Text.Trim() != "" && txtprice.Text.Trim() != "" && txtquantity.Text.Trim() != "" && txtdate.Text.Trim() != "" && txtDescription.Text.Trim() != "" && txtcategory.Text.Trim() != "")
                {
                    if (extension == ".jpg" || extension == ".png")
                    {
                        ...
                        if (PhotoFile.HasFile)
                        {
                            ...
                            if (guardado != 0)
                            {
                                alerta.Text = "<script>Swal.fire('Producto actualizado exitosamente', 'Gracias por escogernos', 'success'); </script>";
                                Load_Products();

                            }
                            else
                                alerta.Text = "<script>Swal.fire('Algo salió mal', 'Inténtalo otra vez', 'error') </script>";
                        }
                        else
                        {
                    ...
                    {
                        ClientScript.RegisterStartupScript(this.GetType(), "myalert", "Swal.fire('Formato de imagen incorrecto', 'El formato de imagen debe de ser jpg o png', 'error');", true);
            ...
            {
                alerta.Text = "<script>Swal.fire('Algo salió mal', 'Inténtelo de nuevo', 'error') </script>";
            }
        }
