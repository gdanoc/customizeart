<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="30_ES_Update_seller.aspx.cs" Inherits="CustomizeArt._30_ES_Update_seller" %>
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
    ...
    <title>Tables | Vendedor - Actualizar</title>
                    ...
                    <div class="flex justify-between">
                        <div class="p-1 mx-3 inline-flex items-center">
                            <i class="fas fa-bars pr-2 text-white" onclick="sidebarToggle()"></i>
                                                        <asp:Button ID="btonlogout"  class="btn btn-primary" runat="server" Text="Log Out" OnClick="Unnamed3_Click" />
                                ...
                                <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <asp:Button runat="server" Text="Select" CssClass="btn btn-primary" OnClick="Unnamed1_Click"></asp:Button>
                                            <asp:Button runat="server" Text="Update" CssClass="btn btn-primary" OnClick="Unnamed2_Click"></asp:Button>
                                        </form>
                                        <%--End button--%>
