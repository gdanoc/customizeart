<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="27_ES_Addimage_Default.aspx.cs" Inherits="CustomizeArt._27_ES_Addimage_Default" %>
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
    ...
    <title>Tables | Admin - Añadir Imagen Inicio</title>
                ...
                <header class="bg-nav">
                    <div class="flex justify-between">
                        ...
                        <div class="p-1 flex flex-row items-center">
                            <img onclick="profileToggle()" class="inline-block h-8 w-8 rounded-full" src="img/C-A.png" alt="">
                ...
                <div class="flex flex-1">
                    ...
                    <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav hidden md:block lg:block">
                        ...
                        <ul class="list-reset flex flex-col">
                            ...
                            <li class="w-full h-full py-3 px-2 border-b border-light-border">
                                <a href="26_Addimage_Default.aspx"
                                    class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                            ...
                            <li class="w-full h-full py-3 px-2 border-b border-light-border">
                                <a href="22_Crud_Products.aspx"
                                    class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                                    <i class="fas fa-table float-left mx-2" href="22_Crud_Products.aspx"></i>
                                    Tables
                            ...
                            <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                                <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <asp:Button runat="server" Text="Add Image" CssClass="btn btn-primary" OnClick="btnAdd_Click"></asp:Button>
                                        <asp:Button runat="server" Text="Update Image" CssClass="btn btn-primary" OnClick="btnEdit_Click"></asp:Button>
                                    </div>
