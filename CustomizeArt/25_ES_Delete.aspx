<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="25_ES_Delete.aspx.cs" Inherits="CustomizeArt._25_ES_Delete" %>
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
    ...
    <title>Tables | Admin - Eliminar</title>
 ...
 <a  class="text-white p-2 no-underline hidden md:block lg:block">CustomizeArt</a>
    ...
    <asp:Image ID="ImagePreview" Width="90%" CssClass="py-3" runat="server" />
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <asp:TextBox ID="txtid" runat="server" placeholder="Selecciona el ID del producto..." MaxLength="4" type="text" class="form-control"  onkeypress="return NumCheck(event, this)"></asp:TextBox>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-fullname">Producto</label>
                                            <asp:TextBox ID="txtproduct" runat="server" placeholder="Producto..." type="text" onkeypress="return validar(event)" class="form-control"></asp:TextBox>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-company">Cantidad</label>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-email">Precio</label>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-phone">Fecha</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <asp:TextBox ID="txtDescription" runat="server" placeholder="Descripcion..." type="text" onkeypress="return SignCheck(this)" class="form-control " />
                                        </div>
                                                                                                                                                                    <div class="mb-3">
   ...
   <asp:DropDownList ID="txtcategory" runat="server" class="form-control ">
       <asp:ListItem Value="Clothes"> Ropa </asp:ListItem>
       <asp:ListItem Value="Technology"> Tecnología </asp:ListItem>
       <asp:ListItem Value="Accesories"> Accesorios </asp:ListItem>
       
       </asp:DropDownList>
</div>
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-message">Imagen del Producto</label>
                                        ...
                                        <div class="button-container">
                                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Seleccionar" Style="width: 150px; padding: 10px; margin: 0 auto; display: block;" OnClick="Button1_Click"></asp:Button>
                                            <asp:Button ID="Button2" runat="server" CssClass="btn btn-primary" Text="Eliminar" Style="width: 150px; padding: 10px; margin: 0 auto; display: block;" OnClick="Button2_Click"></asp:Button>
                                        </div>
                                        <%--End button--%>
