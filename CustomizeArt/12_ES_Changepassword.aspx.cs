...
{
    public partial class _12_ES_Changepassword : System.Web.UI.Page
    {
        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            if (txtpassword1.Text.Trim() != "" && txtpassword2.Text.Trim() != "")
            {
                if (txtpassword2.Text == txtpassword1.Text)
                {
                    ...
                    conexion.Close();
                    alerta.Text = "<script>Swal.fire('¡Contraseña actualizada satisfactoriamente!', '', 'success'); </script>";
                    Response.AddHeader("REFRESH", "3;URL=01_ES_Login.aspx");
                    txtpassword1.Text = "";
                    txtpassword2.Text = "";
                }
                else
                {
                    alerta.Text = "<script>Swal.fire('¡Diferentes contraseñas!', 'Las contraseñas no son iguales', 'error'); </script>";
                    txtpassword1.Text = "";
                    txtpassword2.Text = "";
                }
            }
