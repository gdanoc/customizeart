<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="41_ES_customize_clothes.aspx.cs" Inherits="CustomizeArt._41_ES_customize_clothes" %>
    ...
    <div class="footer-middle">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget">
                        <h4 class="widget-title">Enlaces utiles</h4>
                        <!-- End .widget-title -->

                        <ul class="widget-list">
                            <li><a href="09_ES_About_Us.aspx">Acerca de Customize Artt</a></li>
                            <li><a href="https://www.instagram.com/customizeart24/">Contáctanos customizeart2024@gmail.com</a></li>
                            <li><a >O a través de nuestro email profesional: customizeart2024@gmail.com</a></li>
            ...
            <ul class="mobile-menu">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="05_ES_Technology">Technología</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#">Paginas</a>
