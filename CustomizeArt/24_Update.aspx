<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="24_Update.aspx.cs" Inherits="CustomizeArt._24_Update" %>
...
<head>
    ...
    <title>Tables | Admin - Update</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <asp:TextBox ID="txtid" runat="server" placeholder="Select Product's ID..." type="text" class="form-control" onkeypress="return NumCheck(event, this)" MaxLength="4"></asp:TextBox>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <asp:TextBox ID="txtDescription" runat="server" placeholder="Description..." MinLength="10" MaxLength="50" type="text" class="form-control " />
                                            </div>
                                                                                    <div class="mb-3">
