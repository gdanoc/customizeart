...
{
    public partial class _03_ES_Clothes : System.Web.UI.Page
    {
        ...
        protected void Load_Clothes()
        {
            string template = "";

            DataTable products = metodos.Fetch_Clothes(false);
                ...
                template += "<div class='col-sm-12 col-md-3 col-lg-3' style='text-align: center'>" +
                                "<div class='card' style='text-align: center'> " +
                                    ...
                                    "<div class='card-body'> " +
                                        ...
                                        "<a href='41_ES_customize_clothes.aspx?itemId=" + row["ID"] + "' class='btn btn-primary style='margin-top: 5px;'>Agregar al Carrito con Personalización</a>" +
                                    "</div>" +
                                "</div>" +
                            "</div>";
            }
            ProductsLiteralClothes.Text = template;
        }
    }
}
