<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="12_Changepassword.aspx.cs" Inherits="CustomizeArt._12_Changepassword" %>
...
<head>
    ...
    <title>Change Password - Customize Art</title>
                ...
                <div class="login_part_form">
                    <div class="login_part_form_iner">
                        ...
                        <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                 ...
                                 <asp:TextBox ID="txtpassword1" runat="server" placeholder="New Password..." type="password" class="form-control" onpaste="return false" minlength="4" MaxLength="15" />
                                </div>
                                <div class="form-group">
                                 <asp:TextBox ID="txtpassword2" runat="server" placeholder="Confirm New Password..." type="password" class="form-control" onpaste="return false" minlength="4" MaxLength="15" />
                                </div>
                                 <asp:Button runat="server" Text="New Password" CssClass="btn_3" Style=" margin-top: 20px;" OnClick="Unnamed1_Click"></asp:Button>
