<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="05_ES_Technology.aspx.cs" Inherits="CustomizeArt._05_ES_Technology" %>
    ...
    <!-- End .header-middle -->
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Ropa<span>Lista de productos</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
