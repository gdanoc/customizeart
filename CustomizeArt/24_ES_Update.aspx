<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="24_ES_Update.aspx.cs" Inherits="CustomizeArt._24_ES_Update" %>
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
    ...
    <title>Tables | Admin - Actualizar</title>
                    ...
                    <div class="flex justify-between">
                        <div class="p-1 mx-3 inline-flex items-center">
                            <i class="fas fa-bars pr-2 text-white" onclick="sidebarToggle()"></i>
                                                        <asp:Button ID="btonlogout"  class="btn btn-primary" runat="server" Text="Cerrar Sesión" OnClick="Unnamed3_Click" />
...
<a  class="text-white p-2 no-underline hidden md:block lg:block">CustomizeArt</a>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <asp:TextBox ID="txtid" runat="server" placeholder="Selecciona el ID del producto..." type="text" class="form-control" onkeypress="return NumCheck(event, this)" MaxLength="4"></asp:TextBox>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="basic-default-fullname">Producto</label>
                                                <asp:TextBox ID="txtproduct" runat="server" placeholder="Producto..." type="text" class="form-control" onkeypress="return validar(event)"></asp:TextBox>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <asp:TextBox ID="txtDescription" runat="server" placeholder="Descripcion..."  MinLength="10" MaxLength="50" type="text" class="form-control " />
                                            </div>
                                                                                    <div class="mb-3">
   ...
   <asp:DropDownList ID="txtcategory" runat="server" class="form-control ">
       ...
       <asp:ListItem Value="Technology"> Tecnologia </asp:ListItem>
       <asp:ListItem Value="Accesories"> Accesorios </asp:ListItem>
                                            ...
                                            <asp:Button runat="server" Text="Seleccionar" CssClass="btn btn-primary" OnClick="Unnamed1_Click"></asp:Button>
                                            <asp:Button runat="server" Text="Actualizar" CssClass="btn btn-primary" OnClick="Unnamed2_Click"></asp:Button>
                                        </form>
                                        <%--End button--%>
