<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="38_ES_seller_create.aspx.cs" Inherits="CustomizeArt._38_ES_seller_create" %>
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
    ...
    <title>Formularios | Vendedor - Crear</title>
...
<script>
    function SignCheck(input) {
        ...
        if (!valido) {
            alert("Solo se permiten números, letras y espacios.");
...
<body>
    ...
    <div class="mx-auto bg-grey-lightest">
        ...
        <div class="min-h-screen flex flex-col">
            ...
            <header class="bg-nav">
                <div class="flex justify-between">
                    <div class="p-1 mx-3 inline-flex items-center">
                        ...
                        <h1 class="text-white p-2">Logotipo</h1>
                    </div>
                                ...
                                <div class="mb-2 border-solid border-grey-light rounded border shadow-sm w-full md:w-1/2 lg:w-1/2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <asp:TextBox ID="txtDescription" runat="server" placeholder="Descripción..." type="text" onkeypress="return SignCheck(this)" class="form-control"></asp:TextBox>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-company">Categoría</label>
                                        ...
                                        <asp:Button runat="server" Text="Crear" CssClass="btn btn-primary" OnClick="Unnamed1_Click"></asp:Button>
                                    </div>
                                </div>
                            </div>
            ...
            <footer class="bg-white-500 h-screen p-4 overflow-hidden">
                <div class="flex justify-center mb-4">
                    <p class="text-sm text-gray-600">© 2023 Todos los derechos reservados.</p>
                </div>
            </footer>
            <!--/Footer-->
        </div>
