<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="42_ES_customize_technology.aspx.cs" Inherits="CustomizeArt._42_ES_customize_technology" %>
                        ...
                        <div class="header-dropdown">
                            ...
                            <div class="header-menu">
                                <ul>
                                    ...
                                    <li><a href="01_ES_Login.aspx">Inglés</a></li>
                                </ul>
                            </div>
                            <!-- End .header-menu -->
                        </div>
                    ...
                    <div class="header-left">
                        ...
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                ...
                                <li>
                                    <a href="#" class="sf-with-ul" f>Paginas</a>
                                        ...
                                        <div>
                                            ...
                                            <div class="btn-group dropend">
                                                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="btn btn-primary dropdown-toggle">
                                                    ...
                                                    <asp:ListItem Text="Predeterminado" Value="Default"></asp:ListItem>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="widget">
                            ...
                            <ul class="widget-list">
                                ...
                                <li><a>O a nuestro email profesional: customizeart2024@gmail.com</a></li>
                                <li><a href="01_ES_Login.aspx">Iniciar Sesión</a></li>
                            </ul>
                            <!-- End .widget-list -->
                        </div>
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="09_ES-About_Us.aspx">Sobre Nosotros</a>
                            </li>
                            <li>
