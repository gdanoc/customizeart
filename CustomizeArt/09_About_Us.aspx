<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="09_About_Us.aspx.cs" Inherits="CustomizeArt._09_About_Us" %>
...
<head>
    ...
    <title>About Us - Customize Art</title>
        ...
        <main class="main">
            ...
            <div class="page-content pb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1">
                            <div class="about-text text-center mt-3">
                                ...
                                <p>This website it’s an online store where customers can buy their own personalized products. This site is very easy to navigate. Customize Art is an easy-to-use online store for buying personalized products.</p>
                            </div>
                            <!-- End .about-text -->
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box icon-box-sm text-center">
                                ...
                                <div class="icon-box-content">
                                    ...
                                    <!-- End .icon-box-title -->
                                    <p>
                                        This website contains excelents animations 
                                        <br>
                                        and a unique and soft design to your sight.
                                    </p>
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box icon-box-sm text-center">
                                ...
                                <div class="icon-box-content">
                                    ...
                                    <!-- End .icon-box-title -->
                                    <p>
                                        This project was made with the support
                                        <br>
                                        of the teachers, lessons and
                                        <br>
                                        tips through the evaluations.
                                    </p>
                                </div>
                                <!-- End .icon-box-content -->
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="icon-box icon-box-sm text-center">
                                ...
                                <div class="icon-box-content">
                                    <h3 class="icon-box-title">Made With Effort And Teamwork</h3>
                                    <!-- End .icon-box-title -->
                                    <p>
                                        Behind this project there is a teamwork
                                        <br>
                                        that worked in a quiet and
                                        <br>
                ...
                <div class="bg-light-2 pt-6 pb-7 mb-6">
                    <div class="container">
                        <h2 class="title text-center mb-4">Students</h2>
                        <!-- End .title text-center mb-2 -->
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="students/01_student.png" alt="member photo">
                                    ...
                                    <div class="member-content">
                                        <h3 class="member-title">Rafael Mauricio Escobar Marroquín<span>20240030</span></h3>
                                        <!-- End .member-title -->
                                    </div>
                                    <!-- End .member-content -->
                                </div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="students/02_student.png" alt="member photo">
                                    ...
                                    <!-- End .member-media -->
                                    <div class="member-content">
                                        <h3 class="member-title">Rodrigo Andres Guerra Romero<span>20140031</span></h3>
                                        <!-- End .member-title -->
                                    </div>
                                    <!-- End .member-content -->
                                </div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="students/03_student.png" alt="member photo">
                                    ...
                                    <!-- End .member-media -->
                                    <div class="member-content">
                                        <h3 class="member-title">Gerardo Daniel Orellana Campos<span>20160159</span></h3>
                                        <!-- End .member-title -->
                                    </div>
                                    <!-- End .member-content -->
                                </div>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="member member-2 text-center">
                                    <figure class="member-media">
                                        <img src="students/04_student.png" alt="member photo">
                                    ...
                                    <!-- End .member-media -->
                                    <div class="member-content">
                                        <h3 class="member-title">Diego Leonardo Alemán Granados<span>20120201</span></h3>
                                        <!-- End .member-title -->
                                    </div>
                                    <!-- End .member-content -->
                                </div>
