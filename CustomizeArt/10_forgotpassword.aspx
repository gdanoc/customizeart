<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="10_forgotpassword.aspx.cs" Inherits="CustomizeArt._10_forgotpassword" %>
                 ...
                 <div class="login_part_form">
                     <div class="login_part_form_iner">
                         ...
                         <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                  <asp:TextBox ID="txtcuenta" runat="server" placeholder="User..." onkeypress="return SignCheck(this)" type="text" class="form-control" />
                                  <asp:Button runat="server" Text="Recover" CssClass="btn_3" OnClick="Unnamed1_Click"></asp:Button>
                             </div>
