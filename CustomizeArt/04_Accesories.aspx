<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="04_Accesories.aspx.cs" Inherits="CustomizeArt._04_Accesories" %>
...
<li><a href="01_ES_Login.aspx">Spanish</a></li>
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Accesories<span>List of products</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
