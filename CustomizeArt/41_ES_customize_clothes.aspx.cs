...
{
    public partial class _41_ES_customize_clothes : System.Web.UI.Page
    {
        ...
        protected void Unnamed1_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(rawId) && int.TryParse(rawId, out productId))
            {
                ...
                if (CusImage.FileName == "" && impresion.SelectedValue == "Seleccione cara")
                {
                    // Sin personalizar
                    if (DropDownList1.SelectedValue == "Selecciona talla" || colorRadioButtonList.SelectedValue == "")
                    {
                ...
                {
                    // Con personalizar
                    if (DropDownList1.SelectedValue == "Selecciona talla" || colorRadioButtonList.SelectedValue == "" || CusImage.FileName == "" || impresion.SelectedValue == "Selecciona la cara")
                    {
