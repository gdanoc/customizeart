<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="31_ES_Salesseller.aspx.cs" Inherits="CustomizeArt._31_ES_Salesseller" %>
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
    ...
    <title>Tables | Vendedor - Ventas</title>
                ...
                <div class="flex flex-1">
                    ...
                    <aside id="sidebar" class="bg-side-nav w-1/2 md:w-1/6 lg:w-1/6 border-r border-side-nav hidden md:block lg:block">
                        ...
                        <ul class="list-reset flex flex-col">
                            ...
                            <li class="w-full h-full py-3 px-2 border-b border-light-border">
                                <a href="30_ES_Update-Seller.aspx"
                                    class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                                    <i class="fab fa-wpforms float-left mx-2"></i>
                    ...
                    <main class="bg-white-500 flex-1 p-3 overflow-hidden">
                        ...
                        <asp:GridView ID="Sale" CssClass="table table-light table-striped table-hover table-bordered my-3" runat="server" AutoGenerateColumns="False" OnRowDataBound="Sale_RowDataBound">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Producto" HeaderText="Prodcuto" />
                                <asp:BoundField DataField="Cantidad" HeaderText="Cantidad" />
                                <asp:BoundField DataField="Precio Unidad" HeaderText="Precio" />
