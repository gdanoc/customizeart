<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22_ES_Crud_Products.aspx.cs" Inherits="CustomizeArt._22_ES_Crud_Products" %>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="auto-style1">
                                                <%--Create--%>
                                                <asp:Button runat="server" CssClass="btn btn-primary" Style="width: 210px; padding: 20px; border: 1px solid #ccc; margin-top: 20px; margin-bottom: 20px;" ID="Button1" Text="Crear Productos" OnClick="Button1_Click" />
                                                <%--Update--%>
                                                <asp:Button runat="server" CssClass="btn btn-primary" Style="width: 210px; padding: 20px; border: 1px solid #ccc; margin-top: 20px; margin-bottom: 20px;" ID="Button2" Text="Actualizar Productos" OnClick="Button2_Click" />
                                                <%--Hide/Delete--%>
                                                <asp:Button runat="server" CssClass="btn btn-primary" Style="width: 210px; padding: 20px; border: 1px solid #ccc; margin-top: 20px; margin-bottom: 20px;" ID="Button3" Text="Eliminar Productos" OnClick="Button3_Click" />
                                                <%--Add image to the carrousel--%>
                                                <asp:Button runat="server" CssClass="btn btn-primary" Style="width: 210px; padding: 20px; border: 1px solid #ccc; margin-top: 20px; margin-bottom: 20px;" ID="Button4" Text="Agregar imagen al carrusel" OnClick="Button4_Click" />
                                                <%--Add image to the Default--%>
                                                <%--Sales--%>
                                                <asp:Button runat="server" CssClass="btn btn-primary" Style="width: 210px; padding: 20px; border: 1px solid #ccc; margin-top: 20px; margin-bottom: 20px;" ID="Button6" Text="Ventas" OnClick="Button6_Click" />
                                                <%--Tabla--%>
