...
{
    public partial class _38_seller_create : System.Web.UI.Page
    {
            ...
            if (extension == ".jpg" || extension == ".png")
            {
                if (PhotoFile.HasFile)
                {
                    if (txtproduct.Text.Trim() != "" && txtquantity.Text.Trim() != "" && txtprice.Text.Trim() != "" && txtdate.Text.Trim() != "" && txtDescription.Text.Trim() != "" && txtcategory.Text.Trim() != "")
                    {
                        ...
                        if (price > 2000)
                        {
                            string script = "Swal.fire('Price too high', 'The price can´t be higher than 2000', 'warning');";
                        ...
                        if (guardado != 0)
                        {
                            alerta.Text = "<script>Swal.fire('Product added successfully', 'Thanks for choosing us!', 'success'); </script>";
                            Load_Products();
                        }
                        else
                        {
                ...
                {
                    alerta.Text = "<script>Swal.fire('OOPS', 'Choose a Image', 'error') </script>";
                }
            }
            else
            {
