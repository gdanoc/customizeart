<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="12_ES_Changepassword.aspx.cs" Inherits="CustomizeArt._12_ES_Changepassword" %>
...
<head>
    ...
    <title>Cambiar Contaseña - Customize Art</title>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="login_part_form">
                    <div class="login_part_form_iner">
                        <h3>Cambiar Contraseña <br>
                           Ingresa tu nueva contraseña</h3>
                        <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                 <div class="form-group">
                                 <asp:TextBox ID="txtpassword1" runat="server" placeholder="Nueva Contraseña..." type="password" class="form-control" onpaste="return false" minlength="4" MaxLength="15" />
                                </div>
                                <div class="form-group">
                                 <asp:TextBox ID="txtpassword2" runat="server" placeholder="Confirmar Nueva Contraseña..." type="password" class="form-control" onpaste="return false" minlength="4" MaxLength="15" />
                                </div>
                                 <asp:Button runat="server" Text="Nueva Contraseña" CssClass="btn_3" Style=" margin-top: 20px;" OnClick="Unnamed1_Click"></asp:Button>
