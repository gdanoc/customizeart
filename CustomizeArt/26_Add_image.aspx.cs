...
{
    public partial class _26_Add_image : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("32_Update_image.aspx");
        }
        ...
        protected void btnAgregar_click(object sender, EventArgs e)
        {
            ...
            if (extension == ".jpg" || extension == ".png")
            {
                if (PhotoFile.HasFile)
                {
                    ...
                    if (guardado != 0)
                    {
                        ClientScript.RegisterStartupScript(this.GetType(), "myalert", "Swal.fire('Image added successfully', '', 'success');", true);
                    }
                    else
                    {
                ...
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "myalert", "Swal.fire('Select a Image', 'You haven't selected any image', 'error');", true);
                }
            }
            else
            {
