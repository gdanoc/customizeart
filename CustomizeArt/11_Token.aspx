<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="11_Token.aspx.cs" Inherits="CustomizeArt._11_Token" %>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="login_part_form">
                    <div class="login_part_form_iner">
                        <h3>Token<br>
                            Verify the token sent to your email</h3>
                        <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                 ...
                                 <asp:Button runat="server" Text="Verify" CssClass="btn_3" Style=" margin-top: 20px;" OnClick="Unnamed1_Click"></asp:Button>
