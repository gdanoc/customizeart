...
{
    public partial class _07_Shoppingcart : System.Web.UI.Page
    {
        private int userId;
        ...
        protected void CheckOut_Click(object sender, EventArgs e)
        {
                ...
                transactions = new List<Transaction>
            {
                ...
                {
                    return_url = Request.Url.Scheme + "://" + Request.Url.Authority + "/36_complete.aspx",
                    cancel_url = Request.Url.Scheme + "://" + Request.Url.Authority + "/07_ShoppingCart.aspx"
                }
            };
        ...
        {
            Response.Redirect("33_CheckOut.aspx");
        }
