...
{
    public partial class _02_Products : System.Web.UI.Page
    {
                ...
                template += "<div class='col-sm-12 col-md-3 col-lg-3' style='text-align: center'>" +
                                "<div class='card' style='text-align: center'> " +
                                    ...
                                    "<div class='card-body'> " +
                                        ...
                                        "<p class='card-text'> Description: <strong>" + row["Description"] + " </strong> <br> Price: <strong>$" + row["Price"] + "</strong> <br> Category: <strong>" + row["Category"] + "</strong> <br> Stock: <strong>" + row["Quantity"] + " </strong>" + "</p>" +
                                        "<a href='08_prueba.aspx?itemId=" + row["ID"] + "' class='btn btn-primary style='margin-top: 5px;'>Add to Shopping Cart With Customization</a>" +
                                    "</div>" +
                                "</div>" +
                            "</div>";
            }
