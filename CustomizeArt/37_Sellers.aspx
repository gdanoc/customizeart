<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="37_Sellers.aspx.cs" Inherits="CustomizeArt._37_Sellers" %>
...
<div class="mx-auto bg-grey-lightest">
    ...
    <asp:GridView ID="SellerGridView" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False">
        <Columns>
            <asp:BoundField DataField="id_Seller" HeaderText="ID Manager" />
            <asp:BoundField DataField="nombre" HeaderText="Name" />
            <asp:BoundField DataField="Tienda" HeaderText="Store" />
            <asp:BoundField DataField="Descripcion" HeaderText="Description" />
            <asp:BoundField DataField="Correo" HeaderText="Email" />
            <asp:BoundField DataField="Telefono" HeaderText="Phone" />
            <asp:BoundField DataField="ID_ROL" HeaderText="Role ID" />
        </Columns>
    </asp:GridView>
</div>
            </main>
