...
{
    public partial class _04_ES_Accesories : System.Web.UI.Page
    {
        ...
        protected void Load_Accesories()
        {
            string template = "";

            DataTable products = metodos.Fetch_Accesories(false);
                ...
                template += "<div class='col-sm-12 col-md-3 col-lg-3' style='text-align: center'>" +
                                "<div class='card' style='text-align: center'> " +
                                    ...
                                    "<div class='card-body'> " +
                                        ...
                                        "<a href='43_ES_customize_accesories.aspx?itemId=" + row["ID"] + "' class='btn btn-primary style='margin-top: 5px;'>Agregar al Carrito con Personalización</a>" +
                                    "</div>" +
                                "</div>" +
                            "</div>";
            }
            ProductsLiteralAccesories.Text = template;
        }
    }
}
