<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="02_Products.aspx.cs" Inherits="CustomizeArt._02_Products" %>
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
                <div class="container">
                    <h1 class="page-title">Products<span>List Shop</span></h1>
                </div>
                <!-- End .container -->
            </div>
            <!-- End .page-header -->
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
                <div class="container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="01_Default.aspx">Home</a></li>
                        <li class="breadcrumb-item"><a href="01_Login.aspx">Login</a></li>
            ...
            <button class="btn btn-primary" type="submit"><i class="icon-search"></i></button>
                                ...
                                <nav class="mobile-nav">
                                    <ul class="mobile-menu">
                                        ...
                                        <li>
                                            <a href="02_Products.aspx" class="sf-with-ul">Product</a>
                                            <ul>
                                                <li><a href="02_Products.aspx">All Products</a></li>
                                                <li><a href="03_Clothes.aspx">Clothes</a></li>
                                                <li><a href="04_Accesories.aspx"><span>Accesories<span class="tip tip-new">New</span></span></a></li>
                                                <li><a href="05_Technology.aspx">Technology</a></li>
                                            </ul>
