<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="04_ES_Accesories.aspx.cs" Inherits="CustomizeArt._04_ES_Accesories" %>
                                        ...
                                        <div class="banner banner-overlay">
                                            <a href="#">
                                                ...
                                                <div class="banner-content banner-content-bottom">
                                                    <div class="banner-title text-white">Customize Art<br><span><strong>Productoss</strong></span></div><!-- End .banner-title -->
    ...
    <!-- End .header-middle -->
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Accesories<span>List Shop</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
    ...
    <div class="carousel-inner">
        <div class="container">
           ...
           <div class="col-lg-12 col-sm-12">
                <div class="row">
    <asp:Literal ID="ProductsLiteralAccesories" runat="server"></asp:Literal>
</div>
