...
{
    public partial class _32_ES_Update_image : System.Web.UI.Page
    {
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (isNumber)
            {
                ...
                if (eliminado != 0)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "myalert", "Swal.fire('Imagen eliminada exitosamente', '', 'success');", true);
                    cargar_datos();
            ...
            try
            {
                ...
                if (extension == ".jpg" || extension == ".png")
                {
                    ...
                    if (PhotoFile.HasFile) //Verifica si se ha subido un archivo
                    {
                        ...
                        if (guardado != 0)
                        {
                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "Swal.fire('Imagen actualizada exitosamente.', '', 'success');",
                            true);
                            cargar_datos();
                        ...
                        {
                            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "Swal.fire('Algo salió mal', '', 'error');",
                            true);
                        }
                    }
