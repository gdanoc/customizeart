...
{
    public partial class _33_CheckOut : System.Web.UI.Page
    {
        ...
        protected void Buy_Click(object sender, EventArgs e)
        {
            if (txtcuenta.Text != "")
            {
                try
                {
                    ...
                    const string subject = "Confirm Purchase";//Asunto del correo
                    string body = "Dear " + nombrecliente + ",  In this email we are sending your purchase token. Thank you for be our customer. Purchase Token: " + randomCode + "";
                    ...
                    alerta.Text = "<script>Swal.fire('Mail sent successfully', 'Token sent', 'success');</script>";
                    Response.AddHeader("REFRESH", "3;URL=34_Token-Compra.aspx");
                }
                catch
                {
