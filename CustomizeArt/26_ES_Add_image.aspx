<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="26_ES_Add_image.aspx.cs" Inherits="CustomizeArt._26_ES_Add_image" %>
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
    ...
    <title>Tables | Admin - Añadir Imagen Carrusel</title>
                        ...
                        <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                            <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                                <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b">
                                    ...
                                    <small class="text-muted float-end">Personalizacion</small>
                                </div>
                                <div class="card-body">
                                    ...
                                    <asp:Button runat="server" Text="AAgregar Imagen" CssClass="btn btn-primary" OnClick="btnAgregar_click"></asp:Button>
                                    <asp:Button runat="server" Text="Actualizar Imagen" CssClass="btn btn-primary" OnClick="btnEditar_Click"></asp:Button>
                                </div>
