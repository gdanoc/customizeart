<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="34_ES_Token-Compra.aspx.cs" Inherits="CustomizeArt._34_ES_Token_Compra" %>
             ...
             <div class="col-lg-6 col-md-6">
                 <div class="login_part_form">
                     <div class="login_part_form_iner">
                         <h3>Token de Compra</h3>
                         <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                  <asp:TextBox ID="txttoken" runat="server" placeholder="Token de Compra..." minlength="6" MaxLength="6" onkeypress="return numeros(this)" type="text" class="form-control" />
                                  <asp:Button runat="server" Text="Compra" CssClass="btn_3" OnClick="Purchase_Click"></asp:Button>
                             </div>
