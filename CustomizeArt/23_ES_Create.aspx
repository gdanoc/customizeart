<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="23_ES_Create.aspx.cs" Inherits="CustomizeArt._23_ES_Create" %>
...
<link rel="stylesheet" href="assets/css/bootstrap.min.css">
    ...
    <title>Tablas | Admin - Crear</title>
                            ...
                            <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                                <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                                    <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b">
                                        ...
                                        <small class="text-muted float-end">Personalizar Productos</small>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <asp:Button runat="server" Text="Crear Producto" CssClass="btn btn-primary" OnClick="Unnamed1_Click"></asp:Button>
                                    </div>
                                </div>
                            </div>
