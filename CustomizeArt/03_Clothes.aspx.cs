...
{
    public partial class _03_Clothes : System.Web.UI.Page
    {
                ...
                template += "<div class='col-sm-12 col-md-3 col-lg-3' style='text-align: center'>" +
                                "<div class='card' style='text-align: center'> " +
                                    ...
                                    "<div class='card-body'> " +
                                        ...
                                        "<a href='41_customize_clothes.aspx?itemId=" + row["ID"] + "' class='btn btn-primary style='margin-top: 5px;'>Add to Shopping Cart With Customization</a>" +
                                    "</div>" +
                                "</div>" +
                            "</div>";
            }
