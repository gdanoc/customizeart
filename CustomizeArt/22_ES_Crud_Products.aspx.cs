...
{
    public partial class _22_ES_Crud_Products : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("23_ES_Create.aspx");
        }

        protected void Button2_Click(object sender, EventArgs e)
        {
            Response.Redirect("24_ES_Update.aspx");
        }

        protected void Button3_Click(object sender, EventArgs e)
        {
            Response.Redirect("25_ES_Delete.aspx");
        }
        protected void Button4_Click(object sender, EventArgs e)
        {
            Response.Redirect("26_ES_Add_image.aspx");
        }
        ...
        {
            Response.Redirect("28_ES_Sales.aspx");
        }
    }
}