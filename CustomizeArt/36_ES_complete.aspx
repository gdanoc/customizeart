<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="36_ES_complete.aspx.cs" Inherits="CustomizeArt._36_ES_complete" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    ...
                    <br />
                                       <a href="07_ES_ShoppingCart.aspx" class="btn btn-primary">Regresar a la Tienda</a>
...
<%--                                    <a href='35_deletefromcart.aspx?productId=<%# Eval("ProductId") %>&customizeId=<%# Eval("CustomizeId") %>' >Back to the Store</a>--%>
                    ...
                    <h2 class="text-danger">Error de compra</h2>
                    <br />
                    <a href="07_ShoppingCart.aspx" class="btn btn-primary">Regresar a la tienda</a>
