<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="29_Sellerview.aspx.cs" Inherits="CustomizeArt._29_Sellerview" %>
...
<head>
    ...
    <title>Tables | Seller View</title>
    <style type="text/css">
        .auto-style1 {
            height: 24px;
        }
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="auto-style1">
                                                        <%--Update--%>
                                                        <asp:Button runat="server" CssClass="btn btn-primary" Style="width: 210px; padding: 20px; border: 1px solid #ccc; margin-top: 20px; margin-bottom: 20px;" ID="Button2" Text="Update" OnClick="Button1_Click" />
                                                        <%--Sales--%>
                                                        <asp:Button runat="server" CssClass="btn btn-primary" Style="width: 210px; padding: 20px; border: 1px solid #ccc; margin-top: 20px; margin-bottom: 20px;" ID="Button6" Text="Sales" OnClick="Button2_Click" />
                                                        <asp:Button runat="server" CssClass="btn btn-primary" Style="width: 210px; padding: 20px; border: 1px solid #ccc; margin-top: 20px; margin-bottom: 20px;" ID="Button1" Text="Create Products" OnClick="Button3_Click" />
