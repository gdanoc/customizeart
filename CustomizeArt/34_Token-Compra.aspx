<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="34_Token-Compra.aspx.cs" Inherits="CustomizeArt._34_Token_Compra" %>
                 ...
                 <div class="login_part_form">
                     <div class="login_part_form_iner">
                         ...
                         <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                  <asp:TextBox ID="txttoken" runat="server" placeholder="Purchase Token..." minlength="6" MaxLength="6" onkeypress="return numeros(this)" type="text" class="form-control" />
                                  <asp:Button runat="server" Text="Purchase" CssClass="btn_3" OnClick="Purchase_Click"></asp:Button>
                             </div>
