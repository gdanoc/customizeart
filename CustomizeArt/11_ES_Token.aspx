<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="11_ES_Token.aspx.cs" Inherits="CustomizeArt._11_ES_Token" %>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="login_part_form">
                    <div class="login_part_form_iner">
                        <h3>Token<br>
                            Verifica el token enviado a tu correo</h3>
                        <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                 <asp:TextBox ID="txtToken" runat="server" placeholder="Token..." onkeypress="return NumCheck(event, this)" minlength="4" MaxLength="7" type="text" class="form-control" />
                                 <asp:Button runat="server" Text="Verificar" CssClass="btn_3" Style=" margin-top: 20px;" OnClick="Unnamed1_Click"></asp:Button>
