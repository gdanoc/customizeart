<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="03_Clothes.aspx.cs" Inherits="CustomizeArt._03_Clothes" %>
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
                <div class="container">
                    <h1 class="page-title">Clothes<span>List Shop</span></h1>
                </div>
                <!-- End .container -->
            </div>
            <!-- End .page-header -->
            <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
                <div class="container">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="01_Login.aspx">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Shop</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Customize your products</li>
                    </ol>
                </div>
                <!-- End .container -->
            </nav>
                        ...
                        <div class="col-lg-9">
                            ...
                            <section class="product_list section_padding">
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="row">
                                        <asp:Literal ID="ProductsLiteralClothes" runat="server"></asp:Literal>
                                    </div>
